  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col space-y-4">
      ...
      <a
        ...
        className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-green-500/25 group"
        aria-label="WhatsApp"
      >
        <svg
          width="28"
      ...
      <a
        ...
        className="bg-red-600 hover:bg-red-700 text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-red-600/25 group"
        aria-label="Call"
      >
